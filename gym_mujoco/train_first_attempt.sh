...
python ${PATH_SRC}/train.py --filename "${PATH_TRAINED_AGENTS}/${PREFIX}_SAC_vanilla"  --runs $RUNS --SAC --epochs 40
python ${PATH_SRC}/train.py --filename "${PATH_TRAINED_AGENTS}/${PREFIX}_SAC_moderate" --runs $RUNS --SAC --epochs 25 --randomize_reset --disorient
python ${PATH_SRC}/train.py --filename "${PATH_TRAINED_AGENTS}/${PREFIX}_SAC_extreme"  --runs $RUNS --SAC --epochs 35 --randomize_reset --disorient --init_max_vel 2.0 --init_max_angular_vel 1.0 --init_max_attitude 1.5

python ${PATH_SRC}/train.py --filename "${PATH_TRAINED_AGENTS}/${PREFIX}_TD3_vanilla"  --runs $RUNS --TD3 --epochs 40
python ${PATH_SRC}/train.py --filename "${PATH_TRAINED_AGENTS}/${PREFIX}_TD3_moderate" --runs $RUNS --TD3 --epochs 25 --randomize_reset --disorient
python ${PATH_SRC}/train.py --filename "${PATH_TRAINED_AGENTS}/${PREFIX}_TD3_extreme"  --runs $RUNS --TD3 --epochs 35 --randomize_reset --disorient --init_max_vel 2.0 --init_max_angular_vel 1.0 --init_max_attitude 1.5
